...
Filt_T = zeros(1,Nr);
for yy = 4:Nr
    if (EMG_Powers((yy)*Win_width)<thr) && (RatioTD((yy)*Win_width) < Rthr)  
    Filt_D(yy) = 1;
    elseif (EMG_Powers((yy-3)*Win_width)<thr) && (EMG_Powers((yy-2)*Win_width)<thr) && (EMG_Powers((yy-1)*Win_width)<thr)...
...
for a = 1:N3_rows-2
    if Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&...  % On signal which lasts for 30 sec
            ...
            sum(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+60000))) ~= 0; % after On signal 60 seconds state change
        Nk3w = Nk3w+1; 
        
        K3w(Nk3w,1) = find(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+60000)),1,'first'); % time from On signal till state change
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&...  %  
        ...
        K3(Nk3,1) = 61000; % define seconds for trace with non changed state
...
for a = 1:N3_rows-2
        ...
        K2w(Nk2w,1) = find(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+60000)),1,'first');
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&... %% 
        ...
        %Vecto_AL2(Nk2,:) = AL(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        %Vecto_AR2(Nk2,:) = AR(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        %Vecto_FL2(Nk2,:) = FL(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        Vecto_FR2(Nk2,:) = FR(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        Vecto_EMG2(Nk2,:) = EMG(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        VectoS2(Nk2,:) = Sig(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
...
for a = 1:N3_rows-2
    ...
    if Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&... %  Same, only 10 second awake  before stimulation
        ...
        K3nw(Nk3nw,1) = find(ScorR((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+60000)),1,'first');
...
for a = 1:N3_rows-2  
    if Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&... %% 
        ...
        K2nw(Nk2nw,1) = find(ScorR((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+60000)),1,'first');
        
        %Vecto_AL2nw(Nk2nw,:) = AL(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        %Vecto_AR2nw(Nk2nw,:) = AR(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        %Vecto_FL2nw(Nk2nw,:) = FL(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        Vecto_FR2nw(Nk2nw,:) = FR(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        Vecto_EMG2nw(Nk2nw,:) = EMG(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        VectoS2nw(Nk2nw,:) = Sig(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&... %% 
        ...
        %Vecto_AL2n(Nk2n,:) = AL(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        %Vecto_AR2n(Nk2n,:) = AR(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        %Vecto_FL2n(Nk2n,:) = FL(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        Vecto_FR2n(Nk2n,:) = FR(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        Vecto_EMG2n(Nk2n,:) = EMG(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));
        VectoS2n(Nk2n,:) = Sig(1,(Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)+59999));

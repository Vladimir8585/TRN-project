...
for a = 1:N3_rows-2
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&...
            sum(Scorr((Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+10000))) == 0;
        Nk30 = Nk30+1;
        
        %Vecto_AL3(Nk30,:) = AL(1,(Scorr_sig3(a,1)-30000):(Scorr_sig3(a,1)+59999));
        Vecto_AR3(Nk30,:) = AR(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+9999));
        Vecto_FL3(Nk30,:) = FL(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+9999));
        Vecto_FR3(Nk30,:) = FR(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+9999));
        Vecto_EMG3(Nk30,:) = EMG(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+ 9999));
        VectoS3(Nk30,:) = Sig(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+ 9999));

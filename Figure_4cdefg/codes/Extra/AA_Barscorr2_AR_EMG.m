...
%% making automatic scorage for Awake detection
...
for a = 1:N3_rows-2
    if Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=59999 && ...  % On 60_120 
            sum(Scorr((Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)))) == 0 && ...
            sum(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+120000))) ~= 0;
        Nk60 = Nk60+1;
        
        K60(Nk60,1) = find(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+120000)),1,'first');
        

        Vecto_AL6(Nk60,:) = AL(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+119999));
        %Vecto_AR6(Nk60,:) = AR(1,(Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)+119999));
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=59999 && ...  % Over 80 sleep 
            sum(Scorr((Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)))) == 0 && ...
            sum(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+120000))) == 0;
        Zk60 = Zk60+1;
        Kp60(Zk60,1) = 121000;
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&... %% On 30_60
            sum(Scorr((Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)))) == 0 && ...
...
for a = 1:N3_rows-2
    ...
    if Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=59999 && ...  % On 60_120 (20 sec)
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=59999 && ...  % On 60_120 (20 sec)
            sum(Scorr((Scorr_sig3(a,1)-20000):(Scorr_sig3(a,1)))) == 0 && ...
            sum(Scorr((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+120000))) == 0;
        Zk60f = Zk60f+1;
...
for a = 1:N3_rows-2
    ...
    if Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=59999 && ...  % On 60_120 (awake)
            sum(ScorR((Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)))) == 0 && ...
            sum(ScorR((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+120000))) ~= 0;
        Nk60n = Nk60n+1;
    ...
    elseif Scorr_sig3(a,2) == 1 && (Scorr_sig3(a+1,3))>=29999 && (Scorr_sig3(a+1,3))< 35000 &&... %% On 30_60 (awake)
            sum(ScorR((Scorr_sig3(a,1)-10000):(Scorr_sig3(a,1)))) == 0 && ...
            sum(ScorR((Scorr_sig3(a,1)):(Scorr_sig3(a,1)+80000))) ~= 0;
        Nk30n = Nk30n+1;
